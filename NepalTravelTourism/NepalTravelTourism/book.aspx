<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="book.aspx.cs" Inherits="NepalTravelTourism.book" EnableEventValidation ="false" %>
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
   ...
   <!---->
              ...
              <p class="title"><span>Arrival Details :</span></p><hr />
               ...
               <p class="title"><span>Payment Method :</span></p><hr />
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="Submit" runat="server" Text="Book now" />
                       </div>
    ...
    <asp:Panel ID="Panel2" runat="server">
        <h1>Your Booking has succeeded</h1>
    </asp:Panel>
