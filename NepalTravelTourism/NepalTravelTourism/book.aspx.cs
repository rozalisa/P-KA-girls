...
namespace NepalTravelTourism
{
    public partial class book : System.Web.UI.Page
    {
        ...
        public bool InsrtIntoDatabase()
        {
            ...
            {
                cmd.Parameters.Add("@airlines", SqlDbType.NVarChar).Value = Convert.ToDateTime(Airlines.Text);
            }
            ...
            {
                cmd.Parameters.Add("@flightNo", SqlDbType.NVarChar).Value = Convert.ToDateTime(FlightNo.Text);
            }
        ...
        /* public void display()
         {
             ...
             children1.Text = NoOfChildren.Text.ToString();
             ...
             //yourTotal1.Text = calculateAmount().Tostring();
